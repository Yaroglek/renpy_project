...
label second_day:
    ...
    # я сделал гифки из 2 пикч, их можно использовать вместо стандартных артов. но немного тупо будет выглядеть открывающий рот перс, когда говорит не он, так что хз, как это использовать.
    #outro
