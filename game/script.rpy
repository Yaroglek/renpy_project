...
label start:
    ...
    menu:
        ...
        "Полностью согласен":  
            ...
            rat "Превосходно."
            rat "В этом месте наблюдается критическая нехватка адекватных и профессиональных работников."
            oleg "Не переживайте, я не подведу."
        "Не согласен"
            oleg "Как по мне, "
            # Крыса это запомнит, мб какие-то очки отношений надо сделать.

    rat "Тогда не буду больше отвлекать, у Вас сегодня много дел."
