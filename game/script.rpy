...
label start:
    ...
    oleg_thoughts "(Да уж, это был безумный день, но надо двигаться дальше. Завтра предстоит поставить свою систему безопасности на все компьютеры в офисе.)"
    ...
    scene office2 with fade
    oleg_thoughts "(Так, вот я и в офисе. Сейчас нужно быстро внедрить свою программу на компьютеры Екатерины и Геннадия)"

    scene black_screen with fade
    "Компьютер" "* звук включения *"

    scene office2 with fade
    oleg_thoughts "(Все, готово, теперь нужно сделать это же с компьютерами Анатолия и Сергея)"
