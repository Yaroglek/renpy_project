...
label second_day:
    ...
    show bossx
    boss "Хорошо. Запись будет у меня уже вечером. Зайдите ко мне, когда все сотрудники покинут офис."
    hide bossx
    ...
    boss "Расследование уже слишком затянулось, Сергей."
    ...
    # боссу сказать что засек активность ночью с компа сереги. Босс скажет что проверит. На протяжении дня расспрашивать сотрудников. Вечером поход к боссу и размышления о том кто это сделал.
    # на следующий день приговор одному из сотрудников и последствия
